...
import {
  ...
  transition,
  trigger
} from "./chunk-G67UTYSX.js";
import {
  MatButton,
  MatButtonModule
} from "./chunk-ZIREYLHQ.js";
import {
  BidiModule,
  BreakpointObserver,
  Breakpoints,
...
var MatSnackBarRef = class {
  constructor(containerInstance, _overlayRef) {
    ...
    this._afterDismissed = new import_rxjs2.Subject();
    this._afterOpened = new import_rxjs2.Subject();
    this._onAction = new import_rxjs2.Subject();
...
var _MatSnackBarContainer = class _MatSnackBarContainer extends BasePortalOutlet {
  constructor(_ngZone, _elementRef, _changeDetectorRef, _platform, snackBarConfig) {
    ...
    this._onAnnounce = new import_rxjs2.Subject();
    this._onExit = new import_rxjs2.Subject();
    this._onEnter = new import_rxjs2.Subject();
...
var _MatSnackBar = class _MatSnackBar {
  ...
  _attach(content, userConfig) {
    ...
    this._breakpointObserver.observe(Breakpoints.HandsetPortrait).pipe((0, import_operators2.takeUntil)(overlayRef.detachments())).subscribe((state2) => {
